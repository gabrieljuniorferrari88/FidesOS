	...
	return (
		<div className="bg-background flex min-h-dvh flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-md text-center">
				<Frown className="text-primary mx-auto size-12" />
				<h1 className="text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
					Página não encontrada
				</h1>
				<p className="text-muted-foreground mt-4">
					Não foi possível encontrar o recurso solicitado. Entre em
					contato com o administrador do site se achar que isso é um
					erro.
				</p>
				<div className="mt-6">
					<Link
